...
const Home = () => {
  ...
  return (<>
    ...
    <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins pt-10 lg:pt-14">
      ...
      <h1 className="text-center mt-32 text-[40px] leading-[48px] md:text-6xl md:leading-[70px]  font-semibold max-w-3xl">
        Turn thoughts into websites instantly, with AI.
      </h1>

      <p className="text-center text-base max-w-md mt-2">
        Create, customize and publish website faster than ever with our AI infinity builder.
      </p>
