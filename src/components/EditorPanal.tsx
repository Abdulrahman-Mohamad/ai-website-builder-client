    ...
    return (
        <div className="absolute top-4 right-4 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 z-50 animate-in fade-in slide-in-from-right-5">
            ...
            <div className="space-y-4 text-black">
                <div>
                    <label htmlFor="content" className="block text-xs font-medium text-gray-500 mb-1">Text Content</label>
                    <textarea
                        id="content"
                        value={values.text}
                ...
                <div>
                    <label htmlFor="className" className="block text-xs font-medium text-gray-500 mb-1">Class Name</label>
                    <input
                        type="text"
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                        <label htmlFor="fontSize" className="block text-xs font-medium text-gray-500 mb-1">Font size</label>
                        <input
                            type="text"
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                        <label htmlFor="backgroundColor" className="block text-xs font-medium text-gray-500 mb-1">Background</label>
                    ...
                    <div>
                        <label htmlFor="color" className="block text-xs font-medium text-gray-500 mb-1">Text Color</label>
                        <div className="flex items-center gap-2 border border-gray-400 rounded-md p-1">
                            <input
                                type="color"
