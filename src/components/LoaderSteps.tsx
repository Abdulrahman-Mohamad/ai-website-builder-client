...
const steps = [
  ...
  { icon: TriangleIcon, label: "Assembiling UI components..." },
...
const LoaderSteps = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
      ...
      <div className="relative z-10 size-32 flex-center">
        ...
        <Icon className="size-8 text-white opacity-80 animate-bounce" />
      </div>
      ...
      <p className="text-xs text-gray-400 mt-2 transition-opacity duration-700 opacity-100">This may take around 2-3 minits...</p>
    </div>
  )
}
